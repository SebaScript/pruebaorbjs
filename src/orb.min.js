...
!(function (e) {
  ...
  return (function e(t, n, o) {
  ...
  })(
    {
      1: [
        function (e, t) {
          (t.exports.utils = e("./orb.utils")),
            (t.exports.pgrid = e("./orb.pgrid")),
            (t.exports.pgridwidget = e("./orb.ui.pgridwidget")),
            (t.exports.query = e("./orb.query")),
            (t.exports.export = e("./orb.export.excel"));
        },
        {
          "./orb.export.excel": 6,
          "./orb.pgrid": 8,
          ...
          (t.exports = function (e, t) {
                      ...
                      void 0 !== h[p]
                        ...
                        : (i.values.push(p),
                          (i = new o(
                            ...
                            c,
                            !1,
                            u == l.dimensionsCount - 1
                          )),
                          (h[p] = i),
                          (i.rowIndexes = []),
                          l.dimensionsByDepth[c].push(i)),
                        i.rowIndexes.push(t);
                    }
              }
            }
            ...
            null != e &&
              ...
              (this.update = function () {
                (l.dimensionsCount = l.fields.length),
                  (l.root = new o(
                    ++s,
                    null,
                    null,
                  ...
                  (l.dimensionsByDepth = {});
                for (var e = 1; e <= l.dimensionsCount; e++)
                  l.dimensionsByDepth[e] = [];
                i();
                for (var t = 0; t < l.fields.length; t++) {
                  var n = l.fields[t];
                  ("asc" === n.sort.order || "desc" === n.sort.order) &&
                    l.sort(n, !0);
                }
              }),
              (this.sort = function (e, t) {
                if (null != e) {
                  t !== !0 &&
                    (e.sort.order = "asc" !== e.sort.order ? "asc" : "desc");
                  for (
                    var n = l.dimensionsCount - a(e),
                      o =
                        n === l.dimensionsCount
                          ? [l.root]
                          : l.dimensionsByDepth[n + 1],
                      r = 0;
                    r < o.length;
                    r++
                  )
                    o[r].values.sort(),
                      "desc" === e.sort.order && o[r].values.reverse();
                }
              }));
          }),
            (t.exports.Type = r);
        },
        { "./orb.dimension": 5, "./orb.utils": 17 },
      ],
      4: [
        function (e, t) {
          function n(e, t, n) {
          ...
          function o() {
            for (
              var e = { configs: [], sorts: [], subtotals: [], functions: [] },
                t = 0;
              t < arguments.length;
              t++
            ) {
            ...
            return new h(
              {
                ...
                subTotal: {
                  ...
                  collapsed:
                    n("collapsed", s.subtotals, !1) &&
                    n("collapsible", s.subtotals, !0),
                },
          ...
          function a(e) {
            (e = e || {}),
              (this.rowsvisible =
                void 0 !== e.rowsvisible ? e.rowsvisible : !0),
              (this.columnsvisible =
                void 0 !== e.columnsvisible ? e.columnsvisible : !0);
          }
          function i(e, t) {
            var n = {
            ...
            (e = e || {}),
              (this.visible = void 0 !== e.visible ? e.visible : n.visible),
              (this.collapsible =
                void 0 !== e.collapsible ? e.collapsible : n.collapsible),
              (this.collapsed =
                void 0 !== e.collapsed ? e.collapsed : n.collapsed);
          }
          function l(e) {
            (e = e || {}),
              (this.order = e.order),
              (this.customfunc = e.customfunc);
          }
          var s = e("./orb.utils"),
            u = e("./orb.axe"),
            c = e("./orb.aggregation"),
            ...
            h = (t.exports.field = function (e, t) {
              ...
              (e = e || {}),
                (this.name = e.name),
                (this.caption = e.caption || this.name),
                (this.sort = new l(e.sort)),
                (this.subTotal = new i(e.subTotal));
              var o, r;
              (this.aggregateFunc = function (e) {
                ...
                (this.aggregateFuncName =
                  e.aggregateFuncName ||
                  (e.aggregateFunc
                    ? s.isString(e.aggregateFunc)
                      ? e.aggregateFunc
                      : "custom"
                    : null)),
                this.aggregateFunc(e.aggregateFunc),
                this.formatFunc(e.formatFunc || n),
                t !== !1 &&
                  (((this.rowSettings = new h(e.rowSettings, !1)).name =
                    this.name),
                  ((this.columnSettings = new h(e.columnSettings, !1)).name =
                    this.name),
                  ((this.dataSettings = new h(e.dataSettings, !1)).name =
                    this.name));
            });
          t.exports.config = function (e) {
            function t(e) {
              return "string" == typeof e ? { name: l.captionToName(e) } : e;
            }
            function n(e, t) {
              var n = o(e, t);
              return n > -1 ? e[n] : null;
            ...
            (this.dataSource = e.dataSource || []),
              (this.canMoveFields =
                void 0 !== e.canMoveFields ? !!e.canMoveFields : !0),
              (this.dataHeadersLocation =
                "columns" === e.dataHeadersLocation ? "columns" : "rows"),
              (this.grandTotal = new a(e.grandTotal)),
              (this.subTotal = new i(e.subTotal, !0)),
              (this.width = e.width),
              (this.height = e.height),
              (this.toolbar = e.toolbar),
              (this.theme = p),
              p.current(e.theme),
              (this.rowSettings = new h(e.rowSettings, !1)),
              (this.columnSettings = new h(e.columnSettings, !1)),
              (this.dataSettings = new h(e.dataSettings, !1)),
              ...
              (this.allFields = (e.fields || []).map(function (e) {
                var t = new h(e);
                return (
                  l.dataSourceFieldNames.push(t.name),
                  l.dataSourceFieldCaptions.push(t.caption),
                  t
                );
              })),
              ...
              (this.columnFields = (e.columns || []).map(function (e) {
                return (
                  (e = t(e)), r(l, u.Type.COLUMNS, e, n(l.allFields, e.name))
                );
              })),
              (this.dataFields = (e.data || []).map(function (e) {
                return (e = t(e)), r(l, u.Type.DATA, e, n(l.allFields, e.name));
              })),
              (this.dataFieldsCount = this.dataFields
                ? this.dataFields.length || 1
                : 1);
            var c = {
              subtotals: {
                rows:
                  void 0 !== l.rowSettings.subTotal.visible
                    ? l.rowSettings.subTotal.visible
                    : !0,
                columns:
                  void 0 !== l.columnSettings.subTotal.visible
                    ? l.columnSettings.subTotal.visible
                    : !0,
              },
            };
            (this.getField = function (e) {
              ...
              (this.availablefields = function () {
                return l.allFields.filter(function (e) {
                  ...
                  return (
                    l.dataFields.every(t) &&
                    l.rowFields.every(t) &&
                    l.columnFields.every(t)
                  );
                });
              }),
              (this.getDataSourceFieldCaptions = function () {
                ...
                if (l.dataSource && (e = l.dataSource[0])) {
                  for (
                    var t = s.ownProperties(e), n = [], o = 0;
                    o < t.length;
                    o++
                  )
                    n.push(l.nameToCaption(t[o]));
                  return n;
                }
                return null;
              }),
              (this.getPreFilters = function () {
                ...
                return (
                  e.preFilters &&
                    s.ownProperties(e.preFilters).forEach(function (n) {
                      var o = e.preFilters[n];
                      if (s.isArray(o))
                        t[l.captionToName(n)] = new d.expressionFilter(
                          null,
                          null,
                          o,
                          !1
              ...
              (this.moveField = function (e, t, a, i) {
                ...
                if (h) {
                  ...
                  if (s || d) {
                    ...
                    return (
                      f ||
                        g.subTotal.visible === !1 ||
                        (g.subTotal.visible = null),
                      d && (null != i ? d.splice(i, 0, g) : d.push(g)),
                      (l.dataFieldsCount = l.dataFields
                        ? l.dataFields.length || 1
                        : 1),
                      !0
                    );
                  }
              ...
              (this.toggleSubtotals = function (e) {
                var t,
                  n,
                  o = !l.areSubtotalsVisible(e);
                if (e === u.Type.ROWS)
                  (c.subtotals.rows = o), (n = l.rowFields);
                else {
                  if (e !== u.Type.COLUMNS) return !1;
                  (c.subtotals.columns = o), (n = l.columnFields);
                }
                for (o = o === !1 ? null : !0, t = 0; t < n.length; t++)
                  n[t].subTotal.visible !== !1 && (n[t].subTotal.visible = o);
                return !0;
              }),
              (this.areSubtotalsVisible = function (e) {
                return e === u.Type.ROWS
                  ? c.subtotals.rows
                  : e === u.Type.COLUMNS
                  ? c.subtotals.columns
                  : null;
              ...
              (this.isGrandtotalVisible = function (e) {
                return e === u.Type.ROWS
                  ? l.grandTotal.rowsvisible
                  : e === u.Type.COLUMNS
                  ? l.grandTotal.columnsvisible
                  : !1;
              });
          };
        },
        ...
        function (e, t) {
          t.exports = function (e, t, n, o, r, a, i) {
            ...
            (this.id = e),
              ...
              (this.getRowIndexes = function (e) {
                if (null == l.rowIndexes) {
                  l.rowIndexes = [];
                  for (var t = 0; t < l.values.length; t++)
                    l.subdimvals[l.values[t]].getRowIndexes(l.rowIndexes);
                }
                if (null != e) {
                  for (var n = 0; n < l.rowIndexes.length; n++)
                    e.push(l.rowIndexes[n]);
                  return e;
                }
                return l.rowIndexes;
              });
      ...
      6: [
        function (e, t) {
          var n = e("./orb.utils"),
            ...
            i =
              '<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns="http://www.w3.org/TR/REC-html40"><head><meta http-equiv=Content-Type content="text/html; charset=UTF-8"><!--[if gte mso 9]><xml> <x:ExcelWorkbook>  <x:ExcelWorksheets>   <x:ExcelWorksheet>    <x:Name>###sheetname###</x:Name>    <x:WorksheetOptions>     <x:ProtectContents>False</x:ProtectContents>     <x:ProtectObjects>False</x:ProtectObjects>     <x:ProtectScenarios>False</x:ProtectScenarios>    </x:WorksheetOptions>   </x:ExcelWorksheet>  </x:ExcelWorksheets>  <x:ProtectStructure>False</x:ProtectStructure>  <x:ProtectWindows>False</x:ProtectWindows> </x:ExcelWorkbook></xml><![endif]--></head><body>',
            l = "</body></html>";
          t.exports = function (e) {
            function t(e) {
              return (
                "<td " + m + '><font color="' + h + '">' + e + "</font></td>"
              );
            }
            function s(e, n, o, r) {
              var a,
            ...
            var p = "white" === d,
              ...
              y = s(
                c.dataFields,
                0,
                b - c.dataFields.length,
                '<tr><td><font color="#ccc">Data</font></td>'
              ),
              x =
                '<tr><td style="height: 22px;" colspan="' + b + '"></td></tr>',
              C = s(
                c.columnFields,
                e.layout.rowHeaders.width,
                b - (e.layout.rowHeaders.width + c.columnFields.length)
              ),
              T = (function () {
                for (var n, r = "", a = 0; a < e.columns.headers.length; a++) {
                  ...
                  if (a < e.columns.headers.length - 1)
                    for (n = 0; n < e.layout.rowHeaders.width; n++)
                      l += "<td></td>";
                  else
                    l += c.rowFields.reduce(function (e, n) {
                      return (e += t(n.caption));
                    }, "");
                  (l += i.reduce(function (e, t) {
                    var n =
                      t.type === o.HeaderType.DATA_HEADER
                        ? t.value.caption
                        : t.value;
                    return (e +=
                      "<td " +
        ...
        { "./orb.themes": 11, "./orb.ui.header": 14, "./orb.utils": 17 },
      ],
      7: [
        function (e, t) {
          var n = e("./orb.utils"),
          ...
          o.expressionFilter = function (e, t, a, i) {
            var l = this;
            (this.operator = r.get(e)),
              (this.regexpMode = !1),
              (this.term = t || null),
              this.term &&
                this.operator &&
                this.operator.regexpSupported &&
                n.isRegExp(this.term) &&
                ((this.regexpMode = !0),
                this.term.ignoreCase ||
                  (this.term = new RegExp(this.term.source, "i"))),
              (this.staticValue = a),
              (this.excludeStatic = i),
              (this.test = function (e) {
                ...
                return l.term
                  ? l.operator.func(e, l.term)
                  : l.staticValue === !0 || l.staticValue === o.ALL
                  ? !0
                  : l.staticValue === !1 || l.staticValue === o.NONE
                  ? !1
                  : !0;
              }),
              (this.isAlwaysTrue = function () {
                return !(
                  l.term ||
                  n.isArray(l.staticValue) ||
                  l.staticValue === o.NONE ||
                  l.staticValue === !1
                );
              });
          };
            ...
            MATCH: {
              ...
              func: function (e, t) {
                return e
                  ? e
                      .toString()
                      .search(n.isRegExp(t) ? t : new RegExp(t, "i")) >= 0
                  : !t;
              },
              regexpSupported: !0,
            },
          ...
          t.exports = function (e) {
            ...
            function l() {
              ...
              if (e.length > 0) {
                ...
                for (var t = 0; t < h.config.dataSource.length; t++) {
                  for (
                    var n = h.config.dataSource[t], o = !1, r = 0;
                    r < e.length;
                    r++
                  ) {
                    var a = e[r],
              ...
              if (h.config.dataFieldsCount > 0) {
                ...
                if (o)
                  for (var g = 0; g < o.length; g++)
                    (c = h.config.getDataField(o[g])),
                      r ||
                        (c
                          ? (r = c.aggregateFunc())
                          : ((c = h.config.getField(o[g])),
                            c &&
                              (r = c.dataSettings
                                ? c.dataSettings.aggregateFunc()
                                : c.aggregateFunc()))),
                      c && r && f.push({ field: c, aggregateFunc: r });
                else
                  for (var m = 0; m < h.config.dataFieldsCount; m++)
                    (c = h.config.dataFields[m] || p),
                      (r || c.aggregateFunc) &&
                        f.push({
                          field: c,
              ...
              if (e) {
                ...
                if (
                  (void 0 === d[n] &&
                    (d[n] = e.isRoot
                      ? null
                      : d[e.parent.id] || e.getRowIndexes()),
                  (t[h.columns.root.id] = s(
                    e.isRoot ? null : d[n].slice(0),
                    null
                  )),
                  h.columns.dimensionsCount > 0)
                )
                  for (var o = 0, r = [h.columns.root]; o < r.length; ) {
                    for (
                      ...
                      if (
                        (void 0 === d[c] &&
                          (d[c] = d[c] || u.getRowIndexes().slice(0)),
                        (t[u.id] = s(
                          i,
                          d[c],
                          e.isRoot ? null : e.getRowIndexes()
                        )),
                        !u.isLeaf && (r.push(u), i))
                      ) {
                        d[c] = [];
            ...
            function c() {
              if (
                ((h.dataMatrix = {}),
                (d = {}),
                (h.dataMatrix[h.rows.root.id] = u(h.rows.root)),
                h.rows.dimensionsCount > 0)
              )
            ...
            var d,
              ...
              h = this;
            (this.config = new o(e)),
              (this.filters = h.config.getPreFilters()),
              (this.filteredDataSource = h.config.dataSource),
              (this.rows = new n(h, n.Type.ROWS)),
              (this.columns = new n(h, n.Type.COLUMNS)),
              (this.dataMatrix = {}),
              ...
              (this.getFieldValues = function (e, t) {
                for (
                  var n = [], o = [], r = !1, a = 0;
                  a < h.config.dataSource.length;
                  a++
                ) {
                  var l = h.config.dataSource[a],
                    s = l[e];
                  void 0 !== t
                    ? (t === !0 || ("function" == typeof t && t(s))) &&
                      n.push(s)
                    : s
                    ? n.push(s)
                    : (r = !0);
                ...
                if (n.length > 1) {
                  i.isNumber(n[0]) || i.isDate(n[0])
                    ? n.sort(function (e, t) {
                        return e ? (t ? e - t : 1) : t ? -1 : 0;
                      })
                    : n.sort();
                  for (var u = 0; u < n.length; u++)
                    (0 === u || n[u] !== o[o.length - 1]) && o.push(n[u]);
                } else o = n;
              ...
              (this.getData = function (e, t, n, o) {
                ...
                if (t && n) {
                  ...
                  r =
                    !i || (o && i.aggregateFunc != o)
                      ? h.calcAggregation(
                          t.isRoot ? null : t.getRowIndexes().slice(0),
                          n.isRoot ? null : n.getRowIndexes().slice(0),
                          [a],
                          o
                        )[a]
                      : h.dataMatrix[t.id] && h.dataMatrix[t.id][n.id]
                      ? h.dataMatrix[t.id][n.id][a]
                      : null;
                }
      ...
      9: [
          ...
          var n = e("./orb.utils"),
            ...
            a = function (e, t, o) {
              ...
              (this.source = e),
                (this.query = t),
                (this.filters = o),
                (this.extractResult = function (e, t, n) {
                  if (n.multi === !0) {
                    for (var o = {}, r = 0; r < t.multiFieldNames.length; r++)
                      o[t.multiFieldNames[r]] =
                        e[a.getCaptionName(t.multiFieldNames[r])];
                    return o;
                  }
                ...
                (this.setDefaultAggFunctions = function (e) {
                  ...
                  for (var o = n.ownProperties(r), i = 0; i < o.length; i++) {
                    var l = o[i];
                    "toAggregateFunc" !== l &&
                      (a.query[l] = a.measureFunc(void 0, !0, r[l], e));
                  }
                });
            },
            i = function (e) {
                ...
                return function (n) {
                  return (
                    ...
                    (!e ||
                      e.some(function (e) {
                        var t = n.parent;
                        if (t) for (; t.depth < e.depth; ) t = t.parent;
                        return t === e;
                      }))
                  );
                };
              ...
              (this.getCaptionName = function (e) {
                ...
                (this.cleanOptions = function (e, t, o) {
                  ...
                  if (o.multi === !0) {
                    e && "object" == typeof e
                      ? ((a.aggregateFunc = e.aggregateFunc),
                        (a.multiFieldNames = e.fields))
                      : ((a.aggregateFunc = o.aggregateFunc),
                        (a.multiFieldNames = t));
                    for (var i = 0; i < a.multiFieldNames.length; i++)
                      a.fieldNames.push(n.getCaptionName(a.multiFieldNames[i]));
                  } else
                    (a.aggregateFunc = e), a.fieldNames.push(o.datafieldname);
                  return (
                    a.aggregateFunc &&
                      (a.aggregateFunc = r.toAggregateFunc(a.aggregateFunc)),
                    a
                  );
                }),
                (this.setup = function (e) {
                  var t,
                    r = n.source.config.rowFields,
                    a = n.source.config.columnFields,
                    i = n.source.config.dataFields;
                  for (t = 0; t < r.length; t++)
                    n.slice(r[t], o.Type.ROWS, r.length - t);
                  for (t = 0; t < a.length; t++)
                    n.slice(a[t], o.Type.COLUMNS, a.length - t);
                ...
                (this.slice = function (e, t, o) {
                  n.query[e.name] = n.query[e.caption || e.name] = function (
                    r
                  ) {
                    var a = { name: e.name, val: r, depth: o };
                ...
                (this.applyFilters = function (e) {
                  if (n.filters[e]) {
                    for (
                      var r = n.filters[e].sort(function (e, t) {
                          return t.depth - e.depth;
                        }),
                        a = n.source[e === o.Type.ROWS ? "rows" : "columns"],
                        i = 0,
                        l = null;
                      i < r.length;
                ...
                (this.compute = function (e) {
                  var t,
                    r = n.applyFilters(o.Type.ROWS) || [n.source.rows.root],
                    a = n.applyFilters(o.Type.COLUMNS) || [
                      n.source.columns.root,
                    ];
                  if (1 === r.length && 1 === a.length) {
                    t = {};
                    for (var i = 0; i < e.fieldNames.length; i++)
                      t[e.fieldNames[i]] = n.source.getData(
                        e.fieldNames[i],
                        r[0],
                        a[0],
                        e.aggregateFunc
                    ...
                    for (var l = [], s = [], u = 0; u < r.length; u++)
                      l = l.concat(r[u].getRowIndexes());
                    for (var c = 0; c < a.length; c++)
                      s = s.concat(a[c].getRowIndexes());
                    t = n.source.calcAggregation(
                      l,
                      s,
                      e.fieldNames,
                      e.aggregateFunc
            ...
            l = function (e) {
              ...
              (this.setCaptionName = function (e, t) {
                ...
                (this.cleanOptions = function (e, n, o) {
                  ...
                  if (o.multi === !0) {
                    e && "object" == typeof e
                      ? ((r.aggregateFunc = e.aggregateFunc),
                        (r.multiFieldNames = e.fields))
                      : ((r.aggregateFunc = o.aggregateFunc),
                        (r.multiFieldNames = n));
                    for (var a = 0; a < r.multiFieldNames.length; a++)
                      r.fieldNames.push(t.getCaptionName(r.multiFieldNames[a]));
                  } else
                    (r.aggregateFunc = e || o.aggregateFunc),
                      r.fieldNames.push(o.datafieldname);
                  return r;
                }),
                (this.setup = function (e) {
                  if (
                    ((t.query.slice = function (e, n) {
                      var o = { name: e, val: n };
                    ...
                    for (var o = n.ownProperties(e), r = 0; r < o.length; r++) {
                      var a = o[r],
                        ...
                        l = i.caption || i.name;
                      (i.name = a),
                        t.setCaptionName(l, a),
                        i.toAggregate
                          ? (t.query[a] = t.query[l] =
                              t.measureFunc(a, !1, i.aggregateFunc))
                          : t.slice(i);
                    }
                  return t.setDefaultAggFunctions(e), t.query;
                }),
                (this.slice = function (e) {
                  t.query[e.name] = t.query[e.caption || e.name] = function (
                    n
                  ) {
                ...
                (this.compute = function (e, n, o) {
                  for (
                    var a = t.applyFilters(), i = {}, l = 0;
                    l < e.fieldNames.length;
                    l++
                  ) {
                    var s = e.fieldNames[l],
                      u = r.toAggregateFunc(
                        o === !0
                          ? e.aggregateFunc ||
                              (n && n[s] ? n[s].aggregateFunc : void 0)
                          : e.aggregateFunc
                      );
        ...
        { "./orb.aggregation": 2, "./orb.axe": 3, "./orb.utils": 17 },
      ],
      10: [
        function (e, t) {
          t.exports = function () {
              ...
              (n.getDialogClasses = function (n) {
                ...
                return (
                  e() &&
                    ...
                    (o.content = "modal-content"),
                    (o.header += " modal-header"),
                    (o.title = "modal-title"),
                    (o.body += " modal-body")),
                  o
                );
            ...
            var o = (n.utils = {
              ...
              rgbaToHex: function (e) {
                ...
                if (t) {
                  ...
                  return (
                    "#" +
                    o.applyAlphaAndToHex(t[1], n) +
                    o.applyAlphaAndToHex(t[2], n) +
                    o.applyAlphaAndToHex(t[3], n)
                  );
                }
                return null;
              },
              applyAlphaAndToHex: function (e, t) {
                return (Math.floor(t * parseInt(e) + 255 * (1 - t)) + 256)
                  .toString(16)
                  .substr(1, 2);
              },
              fadeoutColor: function (e, t) {
                return (
                  (e = o.hexToRgb(e)),
                  "#" +
                    o.applyAlphaAndToHex(e.r, t) +
                    o.applyAlphaAndToHex(e.g, t) +
                    o.applyAlphaAndToHex(e.b, t)
                );
              },
            });
            return n;
          ...
          t.exports = function (e) {
            ...
            (this.axe = e),
              ...
              (this.dataFieldsCount = function () {
                return ("columns" === t.axe.pgrid.config.dataHeadersLocation &&
                  t.axe.type === n.Type.COLUMNS) ||
                  ("rows" === t.axe.pgrid.config.dataHeadersLocation &&
                    t.axe.type === n.Type.ROWS)
                  ? t.axe.pgrid.config.dataFieldsCount
                  : 1;
              }),
              ...
              (this.toggleFieldExpansion = function (e, t) {
                for (var n, r = [], a = !0, i = 0; i < this.headers.length; i++)
                  for (n = 0; n < this.headers[i].length; n++) {
                    ...
                    l.type !== o.HeaderType.SUB_TOTAL ||
                      (null != e && l.dim.field.name != e.name) ||
                      (r.push(l), (a = a && l.expanded));
                  }
                if ((void 0 !== t && (a = !t), r.length > 0)) {
                  for (n = 0; n < r.length; n++)
                    a ? r[n].collapse() : r[n].expand();
                  return !0;
                }
                return !1;
              });
      ...
      13: [
                ...
                if (o) {
                  for (var a, l = o.parent, s = 0; s < n.length; s++) {
                    if (((o = n[s]), (a = o.parent), a != l)) {
                      if ((e(l), null != a))
                        for (
                          var u = a.parent, c = l ? l.parent : null;
                          u != c && null != c;
                  ...
                  i.axe.pgrid.config.grandTotal.columnsvisible &&
                    i.axe.dimensionsCount > 1 &&
                    t.push(i.headers[0][i.headers[0].length - 1]);
                }
              }
              if (i.isMultiDataFields()) {
                i.leafsHeaders = [];
                for (var d = 0; d < t.length; d++)
                  for (var p = 0; p < i.dataFieldsCount(); p++)
                    i.leafsHeaders.push(
                      new r.dataHeader(i.axe.pgrid.config.dataFields[p], t[d])
                    );
              ...
              for (
                var o = t[t.length - 1],
                  a =
                    i.axe.root.depth === e
                      ? [null]
                      : t[i.axe.root.depth - e - 1].filter(function (e) {
                ...
                for (
                  var s = a[l], u = null == s ? i.axe.root : s.dim, c = 0;
                  c < u.values.length;
                  c++
                ) {
                  var d,
                    ...
                    h = u.subdimvals[p];
                  d =
                    !h.isLeaf && h.field.subTotal.visible
                      ? new r.header(
                          n.Type.COLUMNS,
                          r.HeaderType.SUB_TOTAL,
                          h,
                          s,
                          i.dataFieldsCount()
                        )
            ...
            o.call(i, e),
              ...
              (this.build = function () {
                if (((i.headers = []), null != i.axe)) {
                  if (
                    i.axe.root.values.length > 0 ||
                    i.axe.pgrid.config.grandTotal.columnsvisible
                  ) {
                    for (var e = i.axe.root.depth; e > 1; e--)
                      i.headers.push([]), a(e, i.headers);
                    i.axe.pgrid.config.grandTotal.columnsvisible &&
                      (i.headers[0] = i.headers[0] || []).push(
                        new r.header(
                          n.Type.COLUMNS,
                          r.HeaderType.GRAND_TOTAL,
                          i.axe.root,
                          null,
                          i.dataFieldsCount()
                        )
        ...
        { "./orb.axe": 3, "./orb.ui.axe": 12, "./orb.ui.header": 14 },
      ],
      14: [
        function (e, t) {
          function n(e) {
            (this.axetype = e.axetype),
              (this.type = e.type),
          ...
          (t.exports.header = function (e, t, r, i, l, s) {
            function u() {
              ...
              var t =
                f.dim.isRoot ||
                f.dim.isLeaf ||
                !f.dim.field.subTotal.visible ||
                f.subtotalHeader.expanded;
              if (!t) return !1;
              for (
                var n = f.parent;
                null != n &&
                (!n.dim.field.subTotal.visible ||
                  (null != n.subtotalHeader && n.subtotalHeader.expanded));

              )
                n = n.parent;
              return null == n || null == n.subtotalHeader
                ? t
                : n.subtotalHeader.expanded;
            }
            function c(e) {
              var t,
                n = 0,
            ...
            n.call(this, {
              ...
              (this.subtotalHeader = s),
              (this.parent = i),
              (this.subheaders = []),
              (this.dim = r),
              (this.expanded = this.getState()
                ? this.getState().expanded
                : t !== a.SUB_TOTAL || !r.field.subTotal.collapsed),
              (this.expand = function () {
                (f.expanded = !0), this.setState({ expanded: f.expanded });
              }),
              (this.collapse = function () {
                (f.expanded = !1), this.setState({ expanded: f.expanded });
              }),
            ...
            (t.exports.dataCell = function (e, t, o, r) {
              (this.rowDimension =
                o.type === a.DATA_HEADER ? o.parent.dim : o.dim),
                (this.columnDimension =
                  r.type === a.DATA_HEADER ? r.parent.dim : r.dim),
                (this.rowType =
                  o.type === a.DATA_HEADER ? o.parent.type : o.type),
                (this.colType =
                  r.type === a.DATA_HEADER ? r.parent.type : r.type),
                (this.datafield =
                  e.config.dataFieldsCount > 1
                    ? "rows" === e.config.dataHeadersLocation
                      ? o.value
                      : r.value
                    : e.config.dataFields[0]),
                n.call(this, {
                  axetype: null,
                  type: a.DATA_VALUE,
                  template: "cell-template-datavalue",
                  value: e.getData(
                    this.datafield ? this.datafield.name : null,
                    this.rowDimension,
                    this.columnDimension
                  ),
                  cssclass:
                    "cell " + a.getCellClass(this.rowType, this.colType),
                  isvisible: t,
                });
            }),
        ...
        function (e, t) {
          ...
          t.exports = function (e) {
            function t() {
              ...
              (c.rows = new a(c.pgrid.rows)),
                (c.columns = new i(c.pgrid.columns));
              var t = c.rows.headers,
                n = c.columns.leafsHeaders;
              (c.layout = {
                rowHeaders: {
                  width:
                    (c.pgrid.rows.fields.length || 1) +
                    ("rows" === c.pgrid.config.dataHeadersLocation &&
                    c.pgrid.config.dataFieldsCount > 1
                      ? 1
                      : 0),
                  height: t.length,
                },
                columnHeaders: {
                  ...
                  height:
                    (c.pgrid.columns.fields.length || 1) +
                    ("columns" === c.pgrid.config.dataHeadersLocation &&
                    c.pgrid.config.dataFieldsCount > 1
                      ? 1
                      : 0),
                },
                ...
                (c.layout.pivotTable = {
                  width:
                    c.layout.rowHeaders.width + c.layout.columnHeaders.width,
                  height:
                    c.layout.rowHeaders.height + c.layout.columnHeaders.height,
                });
              var o,
                l = [];
              if (t.length > 0)
            ...
            (this.pgrid = new o(e)),
              ...
              (this.dataRows = []),
              (this.layout = {
                rowHeaders: { width: null, height: null },
                columnHeaders: { width: null, height: null },
                pivotTable: { width: null, height: null },
              }),
              ...
              (this.toggleFieldExpansion = function (e, t, o) {
                return e === n.Type.ROWS
                  ? c.rows.toggleFieldExpansion(t, o)
                  : e === n.Type.COLUMNS
                  ? c.columns.toggleFieldExpansion(t, o)
                  : !1;
              }),
              (this.toggleSubtotals = function (e) {
              ...
              (this.drilldown = function (e) {
                if (e) {
                  var t,
                    n = e.columnDimension.getRowIndexes(),
                    o = e.rowDimension
                      .getRowIndexes()
                      .filter(function (e) {
                  ...
                  t =
                    e.rowType === r.HeaderType.GRAND_TOTAL &&
                    e.colType === r.HeaderType.GRAND_TOTAL
                      ? "Grand total"
                      : e.rowType === r.HeaderType.GRAND_TOTAL
                      ? e.columnDimension.value + "/Grand total "
                      : e.colType === r.HeaderType.GRAND_TOTAL
                      ? e.rowDimension.value + "/Grand total "
                      : e.rowDimension.value + "/" + e.columnDimension.value;
        ...
        function (e, t) {
          ...
          t.exports = function (e) {
            function t(e, t) {
              if (i.isMultiDataFields())
                for (
                  var n = e[e.length - 1], o = 0;
                  o < i.dataFieldsCount();
                  o++
                )
                  n.push(new r.dataHeader(i.axe.pgrid.config.dataFields[o], t)),
                    o < i.dataFieldsCount() - 1 && e.push((n = []));
            }
            function a(e, o) {
              if (o.values.length > 0)
                for (
                  var l = e.length - 1,
                    s = e[l],
                    u = s.length > 0 ? s[s.length - 1] : null,
                    c = 0;
                  c < o.values.length;
                  c++
                ) {
                  ...
                  c > 0 && e.push((s = [])),
                    ...
                    h.isLeaf
                      ? t(e, f)
                      : (a(e, h),
                        h.field.subTotal.visible && (e.push([d]), t(e, d)));
                }
            }
            var i = this;
            o.call(i, e),
              (this.build = function () {
                ...
                if (null != i.axe) {
                  if (
                    (i.axe.root.values.length > 0 ||
                      i.axe.pgrid.config.grandTotal.rowsvisible) &&
                    (o.push([]),
                    a(o, i.axe.root),
                    i.axe.pgrid.config.grandTotal.rowsvisible)
                  ) {
          ...
          (function (e) {
            (t.exports = {
              ns: function (e, t) {
                var n = e.split("."),
                  o = 0;
                for (t = t || window; o < n.length; )
                  (t[n[o]] = t[n[o]] || {}), (t = t[n[o]]), o++;
                return t;
              },
                ...
                (n.prototype = new Error()),
                  ...
                  (t.btoa =
                    e && e.btoa
                      ...
                      : function (e) {
                          for (
                            var t, r, a = String(e), i = 0, l = o, s = "";
                            a.charAt(0 | i) || ((l = "="), i % 1);
                            s += l.charAt(63 & (t >> (8 - (i % 1) * 8)))
                          ) {
                            if (((r = a.charCodeAt((i += 0.75))), r > 255))
                              throw new n(
      ...
      18: [
        function (e, t) {
              ...
              for (var t = e.node, n = [], o = 0; o < t.rows.length; o++) {
                for (
                  ...
                  if (s.__orb._visible)
                    for (
                      var u = Math.ceil(
                          s.__orb._textWidth / s.__orb._colSpan +
                            s.__orb._paddingLeft +
                            s.__orb._paddingRight +
                            s.__orb._borderLeftWidth +
                            s.__orb._borderRightWidth
                        ),
                        c =
                          (s.__orb._rowSpan > 1 &&
                            s.__orb._rowSpan >= t.rows.length - o,
                          0);
                      c < s.__orb._colSpan;
                      c++
                    ) {
                      for (i = n[a]; i && i.inhibit > 0; )
                        i.inhibit--, a++, (i = n[a]);
                      n.length - 1 < a
                        ? n.push({ width: u })
                        : u > n[a].width && (n[a].width = u),
                        (n[a].inhibit = s.__orb._rowSpan - 1),
                        a++;
                    }
                }
                for (i = n[a]; i; )
                  i.inhibit > 0 && i.inhibit--, a++, (i = n[a]);
              }
              (e.size.width = 0),
                (e.widthArray = n.map(function (t) {
          ...
          function o(e) {
            ...
            return (
              t.visible() || (n += " cell-hidden"),
              t.type === c.HeaderType.SUB_TOTAL &&
                t.expanded &&
                (n += " header-st-exp"),
              t.type === c.HeaderType.GRAND_TOTAL &&
                (1 === t.dim.depth
                  ? (n += " header-nofields")
                  : t.dim.depth > 2 && (n += " header-gt-exp")),
              e.leftmost &&
                (n +=
                  " " +
                  ("cell-template-datavalue" === t.template
                    ? "cell"
                    : "header") +
                  "-leftmost"),
              e.topmost && (n += " cell-topmost"),
              n
            );
          }
          function r(e) {
            var t = this;
            (this.scrollBarComp = e),
              (this.callback = null),
              (this.raise = function () {
          ...
          function a(e, t) {
            function n(e, t) {
              return null == t
                ? "none" != e.parentNode.parentNode.style.display
                : void (e.parentNode.parentNode.style.display = t
                    ? ""
                    : "none");
            }
            function o() {
              if (t) {
                var e = { values: t.staticValue, toExclude: t.excludeStatic };
                t.term
                  ? ((h = !0),
                    (g = t.operator),
                    u.toggleRegexpButtonVisibility(),
                    t.regexpMode
                      ? ((f = !0),
                        u.toggleRegexpButtonState(),
                        (m = t.term.source))
                      : (m = t.term),
                    (v.searchBox.value = m),
                    u.applyFilterTerm(t.operator, t.term))
                  : (i = e),
                  u.updateCheckboxes(e),
                  u.updateAllCheckbox();
              }
            }
            function r() {
              u.toggleRegexpButtonVisibility(),
                v.filterContainer.addEventListener("click", u.valueChecked),
                v.searchBox.addEventListener("keyup", u.searchChanged),
                v.clearSearchButton.addEventListener("click", u.clearSearchBox),
                v.okButton.addEventListener("click", function () {
                  var t = u.getCheckedValues();
                  e.onFilter(
                    g.name,
                    g.regexpSupported && h && f ? new RegExp(m, "i") : m,
                    t.values,
                    t.toExclude
                  );
                }),
              ...
              (this.resizeMouseDown = function (e) {
                ...
                (this.resizeMouseMove = function (l) {
                  if (i) {
                    ...
                    (a.x = l.pageX),
                      (a.y = l.pageY),
                      f >= o && (e.style.width = f + "px"),
                      g >= r &&
                        ((e.style.height = g + "px"),
                        (t.style.height = c.bottom - c.top + h.y + "px")),
                      l.stopPropagation(),
                      l.preventDefault();
                  }
                }),
                n.addEventListener("mousedown", this.resizeMouseDown),
            ...
            (this.init = function (e) {
              (v.filterContainer = e),
                (v.checkboxes = {}),
                (v.searchBox =
                  v.filterContainer.rows[0].cells[2].children[0].rows[0].cells[0].children[0]),
                (v.clearSearchButton =
                  v.filterContainer.rows[0].cells[2].children[0].rows[0].cells[1].children[0]),
                (v.operatorBox =
                  v.filterContainer.rows[0].cells[0].children[0]),
                (v.okButton = v.filterContainer.rows[2].cells[0].children[0]),
                (v.cancelButton =
                  v.filterContainer.rows[2].cells[0].children[1]),
                (v.resizeGrip = v.filterContainer.rows[2].cells[1].children[0]);
              for (
                var t = v.filterContainer.rows[1].cells[0].children[0].rows,
                  n = 0;
                n < t.length;
                n++
              ) {
              ...
              (v.allCheckbox = v.checkboxes[d.ALL]),
                (v.addCheckbox = null),
                (v.enableRegexButton = v.filterContainer.rows[0].cells[1]),
                (l = new a(
                  v.filterContainer.parentNode,
                  v.filterContainer.rows[1].cells[0].children[0],
                  v.resizeGrip
                )),
                o(),
                r();
              ...
              (this.onOperatorChanged = function (e) {
                g.name !== e &&
                  ((g = d.Operators.get(e)),
                  u.toggleRegexpButtonVisibility(),
                  u.searchChanged("operatorChanged"));
              }),
              ...
              (this.toggleRegexpButtonVisibility = function () {
                g.regexpSupported
                  ? (v.enableRegexButton.addEventListener(
                      "click",
                      u.regexpActiveChanged
                    ),
                    p.removeClass(v.enableRegexButton, "srchtyp-col-hidden"))
                  : (v.enableRegexButton.removeEventListener(
                      "click",
                      u.regexpActiveChanged
                    ),
                    p.addClass(v.enableRegexButton, "srchtyp-col-hidden"));
              }),
              (this.toggleRegexpButtonState = function () {
                (v.enableRegexButton.className =
                  v.enableRegexButton.className.replace(
                    "srchtyp-col-active",
                    ""
                  )),
                  f
                    ? p.addClass(v.enableRegexButton, "srchtyp-col-active")
                    : p.removeClass(v.enableRegexButton, "srchtyp-col-active");
              }),
              (this.regexpActiveChanged = function () {
                (f = !f),
                  u.toggleRegexpButtonState(),
                  u.searchChanged("regexModeChanged");
              }),
              (this.valueChecked = function (e) {
                ...
                t &&
                  ...
                  "checkbox" === t.type &&
                  (t == v.allCheckbox
                    ? u.updateCheckboxes({ values: v.allCheckbox.checked })
                    : u.updateAllCheckbox());
              }),
              ...
              (this.searchChanged = function (e) {
                ...
                if (
                  "operatorChanged" === e ||
                  ("regexModeChanged" === e && t) ||
                  t != m
                ) {
                  m = t;
                  var n = h;
                  (h = "" !== t),
                    h && !n && (i = u.getCheckedValues()),
                    ("operatorChanged" !== e || h) && u.applyFilterTerm(g, t),
                    !h && n && u.updateCheckboxes(i),
                    u.updateAllCheckbox();
                }
              }),
                  ...
                  if (0 === l) t = d.NONE;
                    ...
                    for (
                      ...
                      (r = e.values[o]),
                        (a = v.checkboxes[r]),
                        n(a) &&
                          ((!s && a.checked) || (s && !a.checked)) &&
                          t.push(r);
                  return { values: t, toExclude: s };
                }
                return {
              ...
              (this.updateAllCheckbox = function () {
                if (!h) {
                  ...
                  t === c
                    ? ((v.allCheckbox.indeterminate = !0),
                      (v.allCheckbox.checked = !1))
                    : ((v.allCheckbox.indeterminate = !1),
                      (v.allCheckbox.checked = t));
                }
              });
          }
          function i() {
            ...
            return (
              (e.className = "orb-overlay orb-overlay-hidden"),
          ...
          (t.exports.PivotTable = l.createClass({
            ...
            toggleFieldExpansion: function (e, t, n) {
              this.pgridwidget.toggleFieldExpansion(e, t, n) &&
                this.setProps({});
            },
            ...
            onWheel: function (e) {
              var t, n, o;
              e.currentTarget ==
              (t = this.refs.colHeadersContainer.getDOMNode())
                ? ((n = this.refs.horizontalScrollBar),
                  (o = e.deltaX || e.deltaY))
                : (e.currentTarget ==
                    (t = this.refs.rowHeadersContainer.getDOMNode()) ||
                    e.currentTarget ==
                      (t = this.refs.dataCellsContainer.getDOMNode())) &&
                  ((n = this.refs.verticalScrollBar), (o = e.deltaY)),
                n &&
                  n.scroll(o, e.deltaMode) &&
            ...
            synchronizeCompsWidths: function () {
              ...
              (o.colHeadersTable = {
                ...
                (o.colHeadersTable.size = p.getSize(o.colHeadersTable.node)),
                (o.rowHeadersTable = {
              ...
              for (
                var a = [], i = 0, l = 0;
                l < o.dataCellsTable.widthArray.length;
                l++
              ) {
                var s = Math.max(
                  o.dataCellsTable.widthArray[l],
                  o.colHeadersTable.widthArray[l]
                );
                a.push(s), (i += s);
              }
              ...
              c > 0 &&
                ((o.rowHeadersTable.size.width += c),
                (o.rowHeadersTable.widthArray[
                  o.rowHeadersTable.widthArray.length - 1
                ] += c)),
                p.updateTableColGroup(o.dataCellsTable.node, a),
                p.updateTableColGroup(o.colHeadersTable.node, a),
                p.updateTableColGroup(
                  o.rowHeadersTable.node,
                  o.rowHeadersTable.widthArray
                ),
                (o.dataCellsTable.node.style.width = i + "px"),
                (o.colHeadersTable.node.style.width = i + "px"),
                (o.rowHeadersTable.node.style.width = u + "px");
              var d = Math.min(
                i + 1,
                o.pivotContainer.size.width - u - o.verticalScrollBar.size.width
              );
              (o.dataCellsContainer.node.style.width = d + "px"),
                (o.colHeadersContainer.node.style.width = d + "px");
              var h = this.pgridwidget.pgrid.config.height;
              if (h) {
                var f = Math.ceil(
                  Math.min(
                    h -
                      (o.toolbar ? o.toolbar.size.height + 17 : 0) -
                      o.upperbuttonsRow.size.height -
                      o.columnbuttonsRow.size.height -
                      o.colHeadersTable.size.height -
                      o.horizontalScrollBar.size.height,
                    o.dataCellsTable.size.height
                  )
                );
                (o.dataCellsContainer.node.style.height = f + "px"),
                  (o.rowHeadersContainer.node.style.height = f + "px");
              }
              p.updateTableColGroup(t, [
                u,
                d,
                o.verticalScrollBar.size.width,
                Math.max(
                  o.pivotContainer.size.width -
                    (u + d + o.verticalScrollBar.size.width),
                  0
                ),
              ]),
            ...
            render: function () {
              ...
              return (
                ...
                React.createElement(
                  "div",
                  { className: d.container, style: p, ref: "pivotContainer" },
                  t.toolbar && t.toolbar.visible
                    ? React.createElement(
                        "div",
                        { ref: "toolbar", className: "orb-toolbar" },
                        React.createElement(n, { pivotTableComp: e })
                      )
                    : null,
                  React.createElement(
                    "table",
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          "td",
                          { colSpan: "4" },
                          React.createElement(o, { pivotTableComp: e })
                        )
                      ),
                      React.createElement(
                        "tr",
                        ...
                        React.createElement(
                          ...
                          React.createElement(r, { pivotTableComp: e })
                        ),
            ...
            (t.exports.PivotRow = l.createClass({
              render: function () {
                var e,
                  ...
                  i = !1;
                return (
                  (e = this.props.row.map(function (e, a) {
                    var l = !1;
                    return (
                      e.visible() &&
                        r &&
                        (e.dim
                          ? ((e.dim.isRoot &&
                              void 0 === r.topMostCells[e.dim.depth - 1]) ||
                              (!e.dim.isRoot &&
                                void 0 === r.topMostCells[e.dim.depth] &&
                                (e.dim.parent.isRoot ||
                                  r.topMostCells[e.dim.depth + 1] ===
                                    e.dim.parent))) &&
                            ((i = !0), (r.topMostCells[e.dim.depth] = e.dim))
                          : r.topMostCells[0] || (i = r.topMostCells[0] = !0),
                        o ||
                          (t.props.axetype !== u.Type.DATA &&
                            t.props.axetype !== u.Type.COLUMNS) ||
                          0 !== r.lastLeftMostCellVSpan ||
                          ((l = o = !0),
                          (r.lastLeftMostCellVSpan = e.vspan() - 1))),
                  ...
                  r &&
                    r.lastLeftMostCellVSpan > 0 &&
                    !o &&
                    r.lastLeftMostCellVSpan--,
                  React.createElement("tr", { style: a }, e)
                );
              },
            }));
          var m = null,
          ...
          t.exports.PivotCell = l.createClass({
            ...
            updateCellInfos: function () {
              ...
              if (((e.__orb = e.__orb || {}), t.visible())) {
                ...
                if (
                  (r && o.push("padding-left"),
                  a && o.push("border-left-width"),
                  o.length > 0)
                ) {
                  var i = p.getStyle(e, o, !0);
                  r && (m = parseFloat(i[0])),
                    a && (v = parseFloat(i[r ? 1 : 0]));
                }
                p.removeClass(e, "cell-hidden"),
                  (e.__orb._visible = !0),
                  (e.__orb._textWidth = p.getSize(n).width),
                  (e.__orb._colSpan = this.props.cell.hspan(!0) || 1),
                  (e.__orb._rowSpan = this.props.cell.vspan(!0) || 1),
                  (e.__orb._paddingLeft = m),
                  (e.__orb._paddingRight = m),
                  (e.__orb._borderLeftWidth = this.props.leftmost ? 0 : v),
                  (e.__orb._borderRightWidth = 0);
            ...
            render: function () {
              ...
              switch (((this._latestVisibleState = r.visible()), r.template)) {
                ...
                case "cell-template-column-header":
                  var l =
                      r.type === c.HeaderType.WRAPPER &&
                      r.dim.field.subTotal.visible &&
                      r.dim.field.subTotal.collapsible,
                  ...
                  l || s
                    ...
                    : (e =
                        (r.value || "&#160;") +
                        (r.type === c.HeaderType.SUB_TOTAL ? " Total" : ""));
                  break;
                ...
                case "cell-template-datavalue":
                  (e =
                    r.datafield && r.datafield.formatFunc
                      ? r.datafield.formatFunc()(r.value)
                      : r.value),
                    (t = function () {
                      n.props.pivotTableComp.pgridwidget.drilldown(
                        r,
                        n.props.pivotTableComp.id
                      );
                    });
              }
              if (!i) {
                ...
                switch (r.template) {
                  case "cell-template-datavalue":
                    ...
                    break;
                  default:
                    "cell-template-dataheader" != r.template &&
                      r.type !== c.HeaderType.GRAND_TOTAL &&
                      (u = "hdr-val");
                }
                a.push(
                  React.createElement(
                    "div",
                    { key: "cell-value", ref: "cellContent", className: u },
                    React.createElement("div", {
                  ...
                  p.forEach(
                    ...
                    o &&
                      t(o, function () {
                        var t = null;
                        if (
                          (p.forEach(d, function (n) {
                            if (!t) {
                              var a =
                                  n.component.props.axetype ===
                                    i.props.axetype &&
                                  n.component.props.position ===
                                    i.props.position,
                                l =
                                  n.component.props.axetype ===
                                  o.component.props.axetype;
                              if (l && !a) {
                                var s = n.component
                                    .getDOMNode()
                                    .getBoundingClientRect(),
          ...
          t.exports.DropIndicator = l.createClass({
            ...
            onDragOver: function (e) {
              this.isMounted() ? this.setState({ isover: !0 }, e) : e && e();
            },
            onDragEnd: function (e) {
              this.isMounted() ? this.setState({ isover: !1 }, e) : e && e();
            },
            render: function () {
              var e = "drp-indic";
              this.props.isFirst && (e += " drp-indic-first"),
                this.props.isLast && (e += " drp-indic-last");
              var t = {};
              return (
                this.state.isover && (e += " drp-indic-over"),
                React.createElement("div", { style: t, className: e })
              );
            },
          });
          var y = 0;
            ...
            render: function () {
              var e = this,
                ...
                o = this.props.buttons.map(function (t, o) {
                  return o < e.props.buttons.length - 1
                    ? [
                        React.createElement(
                          "td",
                          null,
              ...
              return React.createElement(
                "div",
                {
                  className:
                    "drp-trgt" +
                    (this.state.isover ? " drp-trgt-over" : "") +
                    (0 === o.length ? " drp-trgt-empty" : ""),
                  style: r,
                },
                React.createElement(
                  "table",
          ...
          (t.exports.PivotButton = l.createClass({
            ...
            onFilterMouseDown: function (e) {
              if (0 === e.button) {
                ...
                (o.className =
                  this.props.pivotTableComp.pgrid.config.theme.getFilterClasses().container),
                  (o.style.top = n.y + "px"),
                  (o.style.left = n.x + "px"),
            ...
            componentDidUpdate: function () {
              this.props.pivotTableComp.pgrid.config.canMoveFields &&
                (this.state.mousedown
                  ? this.state.mousedown &&
                    (b.setDragElement(this),
                    document.addEventListener("mousemove", this.onMouseMove))
                  : (b.setDragElement(null),
            ...
            componentDidMount: function () {
              this.props.pivotTableComp.registerThemeChanged(
                this.updateClasses
              );
            },
            componentWillUnmount: function () {
            ...
            onMouseDown: function (e) {
              if (0 === e.button) {
                if (e.ctrlKey)
                  this.props.pivotTableComp.toggleFieldExpansion(
                    this.props.axetype,
                    this.props.field
                  );
                else {
                  ...
                  this.setState({
                    mousedown: !0,
                    mouseoffset: { x: t.x - e.pageX, y: t.y - e.pageY },
            ...
            onMouseUp: function (e) {
              ...
              this.setState({
                ...
                e.ctrlKey ||
                  t ||
                  this.props.pivotTableComp.sort(
                    this.props.axetype,
                    this.props.field
                  );
            },
            ...
            render: function () {
              ...
              var n =
                  "asc" === e.props.field.sort.order
                    ? "sort-asc"
                    : "desc" === e.props.field.sort.order
                    ? "sort-desc"
                    : "",
                o =
                  (e.state.dragging ? "" : "fltr-btn") +
                  (this.props.pivotTableComp.pgrid.isFieldFiltered(
                ...
                r = "";
              return (
                e.props.axetype === u.Type.DATA &&
                  (r = React.createElement(
                    "small",
                    null,
                    " (" + e.props.field.aggregateFuncName + ")"
                  )),
                React.createElement(
                  "div",
                  {
                    ...
                    className:
                      this.props.pivotTableComp.pgrid.config.theme.getButtonClasses()
                        .pivotButton,
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          ...
                          React.createElement("div", {
                            ref: "filterButton",
                            className: o,
                            onMouseDown: e.state.dragging
                              ? null
                              : this.onFilterMouseDown,
                          })
                        )
                      )
                    )
                ...
                if (r.canMoveFields) {
                  ...
                  e = React.createElement(
                    ...
                    React.createElement(
                      "td",
                      { className: "av-flds" },
                      React.createElement(o, { buttons: a, axetype: null })
                    )
                  );
                } else e = null;
            ...
            (t.exports.PivotTableColumnHeaders = l.createClass({
              render: function () {
                var e = this,
                  ...
                  r = { lastLeftMostCellVSpan: 0, topMostCells: {} },
            ...
            (t.exports.PivotTableDataCells = l.createClass({
              render: function () {
                var e = this,
                  t = h.PivotRow,
                  n = this.props.pivotTableComp.pgridwidget,
                  o = { lastLeftMostCellVSpan: 0, topMostCells: {} },
                ...
                return React.createElement(
                  ...
                  { className: "inner-table" },
                  React.createElement("colgroup", null),
                  React.createElement("tbody", null, r)
                );
              },
            }));
          var C = {
            ...
            scrollClient: null,
            getInitialState: function () {
              return { size: 16, mousedown: !1, thumbOffset: 0 };
            },
            componentDidMount: function () {
            ...
            onMouseDown: function (e) {
              if (0 === e.button) {
                ...
                p.addClass(t, "orb-scrollthumb-hover"),
                  this.setState({
                    mousedown: !0,
            ...
            getScrollSize: function () {
              return null != this.scrollClient
                ? p.getSize(this.scrollClient)[this.sizeProp]
                : p.getSize(this.getDOMNode())[this.sizeProp];
            },
            ...
            refresh: function () {
              if (this.scrollClient) {
                var e = this.scrollClient.children[0],
                  ...
                  r =
                    t[this.sizeProp] >= n[this.sizeProp]
                      ? 0
                      : (t[this.sizeProp] / n[this.sizeProp]) * o;
                this.setState(
                  {
                    containerSize: o,
                    size: r,
            ...
            scroll: function (e, t) {
              if (this.state.size > 0) {
                ...
                return (
                  0 > o && (o = 0),
                  o > n && (o = n),
                  this.setState({ thumbOffset: o }, this.scrollEvent.raise),
                  !0
                );
              }
              return !1;
            ...
            render: function () {
              var e = { padding: 0 };
              (e[this.sizeProp] = this.state.size),
                (e[this.offsetCssProp] = this.state.thumbOffset);
              var t = {};
              ...
              return React.createElement(
                "div",
                { className: this.cssClass, style: t, onWheel: this.onWheel },
                o
              );
            },
          };
          (t.exports.HorizontalScrollBar = l.createClass({
            ...
            (t.exports.FilterPanel = l.createClass({
              ...
              onFilter: function (e, t, n, o) {
                this.props.pivotTableComp.applyFilter(
                  this.props.field,
                  e,
                  t,
                  n,
              ...
              onMouseDown: function (e) {
                for (
                  var t = this.getDOMNode().parentNode, n = e.target;
                  null != n;
              ...
              onMouseWheel: function (e) {
                for (
                  var t = this.refs.valuesTable.getDOMNode(), n = e.target;
                  null != n;
              ...
              render: function () {
                ...
                var t = h.Dropdown,
                  n = [];
                (this.filterManager = new a(
                  this,
                  this.pgridwidget.pgrid.getFieldFilter(this.props.field)
                )),
                  (this.values = this.pgridwidget.pgrid.getFieldValues(
                    this.props.field
                  )),
                  e(d.ALL, "(Show All)"),
                  this.values.containsBlank && e(d.BLANK, "(Blank)");
                for (var o = 0; o < this.values.length; o++) e(this.values[o]);
                var r =
                    this.props.pivotTableComp.pgrid.config.theme.getButtonClasses()
                      .orbButton,
                  i = window.getComputedStyle(
                    this.props.pivotTableComp.getDOMNode(),
                    null
                  ),
                  l = {
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        ...
                        React.createElement(t, {
                          values: [
                            d.Operators.MATCH.name,
                            d.Operators.NOTMATCH.name,
                            d.Operators.EQ.name,
                            d.Operators.NEQ.name,
                            d.Operators.GT.name,
                            d.Operators.GTE.name,
                            d.Operators.LT.name,
                            d.Operators.LTE.name,
                          ],
                          selectedValue:
                            s && s.operator
                              ? s.operator.name
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          ...
                          React.createElement("tbody", null, n)
                        )
                      )
                    ),
                    React.createElement(
            ...
            (t.exports.Dropdown = l.createClass({
              openOrClose: function (e) {
                ...
                n.style.display =
                  e.target === t && "none" === n.style.display
                    ? "block"
                    : "none";
              },
              onMouseEnter: function () {
                var e = this.refs.valueElement.getDOMNode();
                (e.className = "orb-tgl-btn-down"),
              ...
              selectValue: function (e) {
                for (
                  var t = this.refs.valuesList.getDOMNode(),
                    n = e.target,
                    o = !1;
                  !o && null != n;
                ...
                if (o) {
                  ...
                  a.textContent != r &&
                    ((a.textContent = r),
                    this.props.onValueChanged && this.props.onValueChanged(r));
                }
              },
              render: function () {
                for (var e = [], t = 0; t < this.props.values.length; t++)
                  e.push(
                    React.createElement("li", {
                      key: "item" + t,
                      dangerouslySetInnerHTML: { __html: this.props.values[t] },
                    })
                  );
                return React.createElement(
                  "div",
              ...
              render: function () {
                ...
                if (t && t.length > 0) {
                  for (var r = [], a = 0; a < t.length; a++)
                    r.push(React.createElement("th", { key: "h" + a }, t[a]));
                  o.push(React.createElement("tr", { key: "h" }, r));
                }
                if (e && e.length > 0)
                  for (var i = 0; i < e.length; i++) {
                    ...
                    o.push(React.createElement("tr", { key: i }, l));
                  }
                return React.createElement(
                  "table",
                  { className: n.table },
          ...
          var T = (t.exports.Dialog = l.createClass({
            ...
            setOverlayClass: function (e) {
              this.overlayElement.className =
                this.props.theme.getDialogClasses(e).overlay;
            },
            componentDidMount: function () {
              (this.overlayElement = this.getDOMNode().parentNode),
                this.setOverlayClass(!0),
              ...
              (e.style.top = (o > i ? (o - i) / 2 : 0) + "px"),
                (e.style.left = (n > a ? (n - a) / 2 : 0) + "px"),
                (e.style.height = i + "px"),
                (t.style.width = a + "px"),
                (t.style.height = i - 45 + "px");
            },
            close: function (e) {
              (e.target == this.overlayElement ||
                "button-close" === e.target.className) &&
                (this.overlayElement.removeEventListener("click", this.close),
                React.unmountComponentAtNode(this.overlayElement),
                this.setOverlayClass(!1));
            },
            render: function () {
              if (this.props.comp) {
                var e = React.createElement(
                    this.props.comp.type,
                    this.props.comp.props
                  ),
                  t = this.props.theme.getDialogClasses();
                return React.createElement(
                  "div",
                  { className: t.dialog, style: this.props.style || {} },
                  React.createElement(
                    "div",
                    { className: t.content },
                    React.createElement(
          ...
          t.exports.Toolbar = l.createClass({
            ...
            componentDidMount: function () {
              for (var e = 0; e < this._toInit.length; e++) {
                ...
                t.init(
                  this.props.pivotTableComp,
                  this.refs[t.ref].getDOMNode()
                );
              }
            },
            componentDidUpdate: function () {
            ...
            render: function () {
              ...
              if (e.toolbar && e.toolbar.visible) {
                for (
                  var t = e.toolbar.buttons
                      ? R.buttons.concat(e.toolbar.buttons)
                      : R.buttons,
                    n = [],
                    o = 0;
                  o < t.length;
                  ...
                  n.push(
                    ...
                    r.init && this._toInit.push({ ref: a, init: r.init });
                }
          ...
          var w = e("../orb.export.excel"),
            R = {
              exportToExcel: function (e) {
                ...
                (t.download = "orbpivotgrid.xls"),
                  (t.href = w(e.props.pgridwidget)),
              ...
              updateSubtotalsButton: function (e, t, n) {
                ...
                var r = "",
                  a = "";
                o
                  ? ((r = "subtotals-visible"), (a = "subtotals-hidden"))
                  : ((r = "subtotals-hidden"), (a = "subtotals-visible")),
                  p.removeClass(n, a),
                  p.addClass(n, r);
              },
              ...
              updateGrandtotalButton: function (e, t, n) {
                ...
                var r = "",
                  a = "";
                o
                  ? ((r = "grndtotal-visible"), (a = "grndtotal-hidden"))
                  : ((r = "grndtotal-hidden"), (a = "grndtotal-visible")),
                  p.removeClass(n, a),
                  p.addClass(n, r);
              },
            ...
            (t.exports.getParentOffset = function (e) {
              if (e) {
                var t = e.getBoundingClientRect(),
                  n =
                    null != e.parentNode
                      ? e.parentNode.getBoundingClientRect()
                      : { top: 0, left: 0 };
